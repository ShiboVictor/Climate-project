...
# 使用pandas模块的read_csv函数读取名为"CHINA-FloodPrediction.csv"的文件。
...
# 使用pandas模块的read_excel函数读取名为"CEEMDAN-CHINA-RX5DAY.xlsx"的文件。
...
csv_path = "CEEMDAN_LSTM_Flood_classification_results.csv"
